...
// re-exported by name so the surface stays intentional; servercore's adapter-only helpers
// (renderError, consumeRateLimit, the body gate, ...) are reachable from servercore itself.
export {
