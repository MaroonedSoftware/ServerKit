...
| `checkStrength(password, ...userInputs)`                            | `Promise<{ valid: boolean, score: number, feedback }>`                               | Pass-through to `PasswordStrengthProvider.checkStrength` for live strength feedback (e.g. a sign-up form meter)                              |
